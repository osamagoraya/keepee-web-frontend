        ...
        <div style={content} className="full-height">
          ...
          <div style={canvas}>
            <Switch>
              ...
              <ProtectedRoute path="/workspace/report/income-tax-advances/:startDate/:endDate" component={(props) => <IncomeTaxAdvances selectedUserId={selectedUserId} selectedUserName={selectedUserName} selectedUserNID={selectedUserNID} {...props}/>} exact/>
